...
// POST /api/job-boost-requests/[id]/dismiss -- clears a request from the
// inbox without invoicing (e.g. staff already handled it manually, or
// it's a duplicate).
export async function POST(
  ...
  try {
    ...
    await logFailure({
      category: 'other',
      route:    '/api/job-boost-requests/[id]/dismiss',
      message:  'Could not dismiss job boost request',
      error:    err,
